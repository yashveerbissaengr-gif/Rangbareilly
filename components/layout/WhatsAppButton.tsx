...
export function WhatsAppButton() {
  const phoneNumber = '919588669056';
  const message = 'Hello ';
  ...
  return (
    <Link
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-[0_0_20px_rgba(37,211,102,0.6)] hover:scale-110 transition-transform duration-300 hover:shadow-[0_0_25px_rgba(37,211,102,0.8)] animate-pulse hover:animate-none"
